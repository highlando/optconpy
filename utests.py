...
class OptConPyFunctions(unittest.TestCase):
	...
	def setUp(self):
        ...
        #self.fenics_sol_u = Expression((_sympy2expression(u_x),
        #                           self._sympy2expression(u_y)),
        #                           t=0.0 )
        #self.fenics_sol_p = Expression(_sympy2expression(p), t=0.0)
